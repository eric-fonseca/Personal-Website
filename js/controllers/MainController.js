app.controller("MainController", ["$scope", function($scope){
  ...
  { 
  	id: "ecoCalc",
    banner: "img/banners/ecoCalcBanner.png", 
    preview: "img/previews/ecoCalc.jpg", 
  ...
  { 
  	id: "jks",
    banner: "img/banners/jksBanner.png", 
    preview: "img/previews/jks.jpg", 
  ...
  { 
  	id: "flicker",
    banner: "img/banners/flickerBanner.png", 
    preview: "img/previews/flicker.jpg", 
    title: "Flicker", 
  ...
  { 
  	id: "moneyTree",
    banner: "img/banners/moneyTreeBanner.png", 
    preview: "img/previews/moneyTree.jpg", 
    title: "Money Tree", 
  ...
  { 
  	id: "tapVsTap",
    banner: "img/banners/tapVsTapBanner.png", 
    preview: "img/previews/tapVsTap.jpg", 
    title: "Tap Vs Tap", 
  ...
  { 
  	id: "ritMaps",
    banner: "img/banners/ritMapsBanner.png", 
    preview: "img/previews/ritMaps.jpg", 
    title: "RIT Maps", 
  ...
  { 
  	id: "infoTunes",
    banner: "img/banners/infoTunesBanner.png", 
    preview: "img/previews/infoTunes.jpg", 
    title: "InfoTunes", 
  ...
  { 
  	id: "superstitions",
    banner: "img/banners/superstitionsBanner.png", 
    preview: "img/previews/superstitions.jpg", 
  ...
  { 
  	id: "guessSketch",
    banner: "img/banners/guessSketchBanner.png", 
    preview: "img/previews/guessSketch.jpg", 
